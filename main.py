...
def show_add_task_popup():
    ...
    # Valeur par défaut : '📝 Non Planifié' si elle existe, sinon la première liste
    default_list = "📝 Non Planifié" if "📝 Non Planifié" in task_lists_data else task_lists_data[0]
    list_var = ctk.StringVar(value=default_list)
